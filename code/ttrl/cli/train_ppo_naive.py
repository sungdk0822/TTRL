...
if __name__ == "__main__":
    ...
    parser.add_argument("--verify_task", type=str, default="math", choices=[
                        "math", "simplerl", "review", "review_group", "think", "ttt", "gpqa", "medxpertqa"], help="which verify to used for the task")
    parser.add_argument("--verify_task_eval", type=str, default="math", choices=[
                        "math", "simplerl", "review", "review_group", "think", "gpqa", "medxpertqa"], help="which verify to used for the task")
